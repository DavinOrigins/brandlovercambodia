    ...
    <div className="bg-white rounded-lg border border-gray-200 shadow-sm">
      ...
      <div className="p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {products.map((product) => (
          <div key={product.id} className="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden hover:shadow-md transition-shadow flex flex-col">
            <ProductCarousel 
            ...
            <div className="p-4 flex flex-col flex-grow">
              <div className="flex justify-between items-start mb-2">
                <span className="text-xs bg-gray-100 px-2 py-1 uppercase rounded text-gray-600">
                  {product.brand}
                </span>
                {product.featured && (
              ...
              <div className="mt-2 text-[#fcac4c] font-semibold">${product.price}</div>
